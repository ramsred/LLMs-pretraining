...
#This is for loading both encoder and classifier weights separately
def load_model(ckpt_path, model_name, device):
    try:
        model = Wav2Vec2BERT(model_name)
...
def process_audio_file(file_path, model, feature_extractor, device):
    ...
    try:
        ...
        # wav=librosa.effects.pitch_shift(wav, sr=8000, n_steps=8)
...
if __name__ == '__main__':
    ...
    # models_list = ['combined_hybrid_lambda0.5_e3_wt_for-norm_asv2021_grl_ep2_20250619_130948_synthetic_only.pt']
    # models_list = ['combined_hybrid_lambda1.0_e3_wt_for-norm_grl_ep2_20250620_200745_synthetic_only.pt']
    # output_csv_files = ['combined_hybrid_lambda1.0_e3_wt_for-norm_grl']
    # models_list = ['combined_hybrid_R12_e3_wt_for-norm_ep1_20250626_160152_synthetic_only.pt']
    # models_list = ['combined_hybrid_R16_e3_wt_for-norm_ep2_20250629_210611_synthetic_only.pt','combined_hybrid_lambda1.0_inc_speaker_network_e3_wt_for-norm_ep2_20250628_183909_synthetic_only.pt']
    # output_csv_files = ['combined_hybrid_R16_e3_wt_for-norm_ep2','combined_hybrid_lambda1.0_inc_speaker_network_e3_wt_for-norm_ep2']
    
    # models_list =['combined_hybrid_R24_e3_wt_for-norm_ep0_20250701_085626_synthetic_only.pt']
    # models_list = ['combined_hybrid_lambda2.0_inc_speaker_network_e3_wt_for-norm_ep1_20250702_095125_synthetic_only.pt']
    # models_list = ['combined_hybrid_lambda1.0_pitch_shift8_reg_speaker_network_e3_wt_for-norm_ep1_20250704_160650_synthetic_only.pt']
    # models_list = ['combined_hybrid_lambda1.0_deep_speaker_network_e10_wt_for-norm_ep3_20250706_041109_synthetic_only.pt']
    # models_list = ['combined_hybrid_lambda1.0_deep_speaker_network_e10_wt_for-norm_ep2_synthetic_only.pt']
    # models_list = ['combined_hybrid_lambda1.0_deep_speaker_network_GELU_e5_wt_for-norm_ep3_synthetic_only.pt']
    # models_list = ['combined_hybrid_lambda1.5_reg_speaker_network_e5_wt_for-norm_ep0_20250707_025530_synthetic_only.pt']
    # models_list = ['combined_hybrid_lambda_schdule_deep_speaker_network_4layer_e5_relu_b72__wt_for-norm_ep4_20250710_220639_synthetic_only.pt']
    models_list = ['combined_hybrid_vic_schedule_e3_relu_b72__wt_for-norm_ep0_20250725_185348_synthetic_only.pt']
    # output_csv_files = ['combined_hybrid_R24_e3_wt_for-norm_ep0']
    # output_csv_files = ['combined_hybrid_lambda2.0_e2_wt_for-norm_grl']
    output_csv_files = ['combined_hybrid_vic_schedule_e3_relu_b72__wt_for-norm_ep0']
    ...
    for model, output_csv in zip(models_list, output_csv_files):
        ...
        """Remove pitch shift in audio file loading when pitch is not applied"""

...
if __name__ == "__main__":
    ...
    # nohup python ../apm0046210-synthetic-speech-detection-train-main/ssd_train/train_grl_w2v2bert.py --data_path "../data/ASVspoof2019_LA/" "../data/in_the_wild/" "../data/ASVspoof2021_LA_eval/" "../data/wavefake/" "../data/LJSpeech-1.1/" --train True --batch_size 72 --epochs 3 --dataset_name "combined_hybrid_lambda0.5_e3_wt_for-norm" >combined_hybrid_lamda0.5_e3_wt_for-norm.log &

    # python ../apm0046210-synthetic-speech-detection-train-main/ssd_train/train_grl_w2v2bert.py --data_path "../data/ASVspoof2021_LA_eval/" --train True --batch_size 72 --epochs 3 --dataset_name "combined_hybrid_lambda0.5_e3_wt_for-norm"

    # python ../apm0046210-synthetic-speech-detection-train-main/ssd_train/train_grl_w2v2bert.py --data_path "../data/LJSpeech-1.1/" --train True --batch_size 72 --epochs 3 --dataset_name "combined_hybrid_lambda0.5_e3_wt_for-norm"
    # nohup python ../apm0046210-synthetic-speech-detection-train-main/ssd_train/train_grl_w2v2bert.py --data_path "../data/ASVspoof2019_LA/" "../data/in_the_wild/" "../data/ASVspoof2021_LA_eval/" "../data/wavefake/" "../data/LJSpeech-1.1/" --train True --batch_size 72 --epochs 3 --dataset_name "combined_hybrid_lambda1.0_e3_wt_for-norm" >combined_hybrid_lamda1.0_e3_wt_for-norm.log &
    # nohup python ../apm0046210-synthetic-speech-detection-train-main/ssd_train/train_grl_w2v2bert.py --data_path "../data/ASVspoof2019_LA/" "../data/in_the_wild/" "../data/ASVspoof2021_LA_eval/" "../data/wavefake/" "../data/LJSpeech-1.1/" --train True --batch_size 72 --epochs 3 --dataset_name "combined_hybrid_R12_e3_wt_for-norm" >combined_hybrid_R12_e3_wt_for-norm.log & --null_rank 12

    # nohup python ../apm0046210-synthetic-speech-detection-train-main/ssd_train/train_grl_w2v2bert.py --data_path "../data/ASVspoof2019_LA/" "../data/in_the_wild/" "../data/ASVspoof2021_LA_eval/" "../data/wavefake/" "../data/LJSpeech-1.1/" --train True --batch_size 72 --epochs 3 --dataset_name "combined_hybrid_lambda0.5_inc_speaker_network_e3_wt_for-norm" >combined_hybrid_lambda0.5_inc_speaker_network_e3_wt_for-norm.log &

    # nohup python ../apm0046210-synthetic-speech-detection-train-main/ssd_train/train_grl_w2v2bert.py --data_path "../data/ASVspoof2019_LA/" "../data/in_the_wild/" "../data/ASVspoof2021_LA_eval/" "../data/wavefake/" "../data/LJSpeech-1.1/" --train True --batch_size 72 --epochs 3 --lambda_adv 1.0 --use_grl True --dataset_name "combined_hybrid_lambda1.0_inc_speaker_network_e3_wt_for-norm" >combined_hybrid_lambda1.0_inc_speaker_network_e3_wt_for-norm.log &

    # nohup python ../apm0046210-synthetic-speech-detection-train-main/ssd_train/train_grl_w2v2bert.py --data_path "../data/ASVspoof2019_LA/" "../data/in_the_wild/" "../data/ASVspoof2021_LA_eval/" "../data/wavefake/" "../data/LJSpeech-1.1/" --train True --batch_size 72 --epochs 3 --dataset_name "combined_hybrid_R16_e3_wt_for-norm" >combined_hybrid_R16_e3_wt_for-norm.log & --null_rank 16

    # nohup python ../apm0046210-synthetic-speech-detection-train-main/ssd_train/train_grl_w2v2bert.py --data_path "../data/ASVspoof2019_LA/" "../data/in_the_wild/" "../data/ASVspoof2021_LA_eval/" "../data/wavefake/" "../data/LJSpeech-1.1/" --train True --batch_size 72 --epochs 1 --null_rank 24 --dataset_name "combined_hybrid_R24_e3_wt_for-norm" >combined_hybrid_R24_e3_wt_for-norm.log &
    #  nohup python ../apm0046210-synthetic-speech-detection-train-main/ssd_train/train_grl_w2v2bert.py --data_path "../data/ASVspoof2019_LA/" "../data/in_the_wild/" "../data/ASVspoof2021_LA_eval/" "../data/wavefake/" "../data/LJSpeech-1.1/" --train True --batch_size 72 --epochs 1 --null_rank 24 --dataset_name "combined_hybrid_R24_e3_wt_for-norm" >combined_hybrid_R24_e3_wt_for-norm_new.log &

    # nohup python ../apm0046210-synthetic-speech-detection-train-main/ssd_train/train_grl_w2v2bert.py --data_path "../data/ASVspoof2019_LA/" "../data/in_the_wild/" "../data/ASVspoof2021_LA_eval/" "../data/wavefake/" "../data/LJSpeech-1.1/" --train True --batch_size 72 --epochs 3 --lambda_adv 2.0 --use_grl True --dataset_name "combined_hybrid_lambda2.0_inc_speaker_network_e3_wt_for-norm" >combined_hybrid_lambda2.0_inc_speaker_network_e3_wt_for-norm.log &
    # nohup python ../apm0046210-synthetic-speech-detection-train-main/ssd_train/train_grl_w2v2bert.py --data_path "../data/ASVspoof2019_LA/" "../data/in_the_wild/" "../data/ASVspoof2021_LA_eval/" "../data/wavefake/" "../data/LJSpeech-1.1/" --train True --batch_size 72 --epochs 3 --lambda_adv 1.0 --use_grl True --pitch_shift 8 --dataset_name "combined_hybrid_lambda1.0_pitch_shift8_reg_speaker_network_e3_wt_for-norm" >combined_hybrid_lambda1.0_pitch_shift8_reg_speaker_network_e3_wt_for-norm.log &

    # nohup python ../apm0046210-synthetic-speech-detection-train-main/ssd_train/train_grl_w2v2bert.py --data_path "../data/ASVspoof2019_LA/" "../data/in_the_wild/" "../data/ASVspoof2021_LA_eval/" "../data/wavefake/" "../data/LJSpeech-1.1/" --train True --batch_size 72 --epochs 3 --lambda_adv 1.0 --use_grl True --dataset_name "combined_hybrid_lambda1.0_deep_speaker_network_e3_wt_for-norm" >combined_hybrid_lambda1.0_deep_speaker_network_e3_wt_for-norm.log &

    # nohup python ../apm0046210-synthetic-speech-detection-train-main/ssd_train/train_grl_w2v2bert.py --data_path "../data/ASVspoof2019_LA/" "../data/in_the_wild/" "../data/ASVspoof2021_LA_eval/" "../data/wavefake/" "../data/LJSpeech-1.1/" --train True --batch_size 128 --epochs 10 --lambda_adv 1.0 --use_grl True --amp_dtype bf16 --use_amp True --dataset_name "combined_hybrid_lambda1.0_deep_speaker_network_e10_wt_for-norm" >combined_hybrid_lambda1.0_deep_speaker_network_e10_wt_for-norm.log &
